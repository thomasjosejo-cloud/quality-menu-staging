...
export const LANDING_SIGNATURES: MenuItem[] = [
  {
    ...
    price: 290,
    description: "Grilled chicken, fried egg, cucumber, lettuce, tomato, mayonnaise and cheese layered between toasted bread",
    category: "Sandwiches",
    isVeg: false,
    containsEgg: true,
    isChefSpecial: true,
  ...
  {
    id: "bir1",
    name: "Thalassery Dum Biryani — Chicken",
    price: 330,
    description: "Traditional Kerala-style dum biryani with kaima rice",
    category: "Biryani",
    isVeg: false,
    isChefSpecial: true,
    spiceLevel: 2,
  ...
  },
  {
    ...
    price: 340,
    description: "Fish cooked with raw mango and coconut in a traditional Kerala-style curry",
    category: "Regional",
    isVeg: false,
    spiceLevel: 2,
  ...
  },
  {
    ...
    name: "Chicken Tikka",
    price: 400,
    description: "Spiced boneless chicken marinated and roasted in the tandoor",
    category: "Tandoor",
    isVeg: false,
    isChefSpecial: true,
    spiceLevel: 2,
